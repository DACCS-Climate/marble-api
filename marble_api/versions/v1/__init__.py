...
from marble_api.versions.v1.survey.routes import survey_admin_router, survey_response_admin_router, survey_user_router
...
user_router.include_router(survey_user_router)
admin_router.include_router(survey_admin_router)
admin_router.include_router(survey_response_admin_router)
